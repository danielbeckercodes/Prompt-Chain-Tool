...
export function StepInlineForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const payload = {
      ...
      llm_temperature:
        temperature.trim() !== "" ? parseFloat(temperature) : null,
  ...
  const selectClass =
    "w-full rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-900/10 dark:focus:ring-zinc-100/20";
